 ...
 * This will enable the CANopen Master Stack, if you want to use it as a slave then comment this line.
 * If you want to use it as a master then you need to define this in your project settings or here.
 * This will enable the CANopen Master Stack and it will be used for communication with other nodes.
*/
#define CANOPEN_MASTER
// Project Specific Includes must be included for some projects.
/*************************************************************************** */
 #define MAX_BOOTUP_NODES 127
...
extern BootupNodeInfo bootupNodes[MAX_BOOTUP_NODES];
extern uint8_t bootupNodeCount;
