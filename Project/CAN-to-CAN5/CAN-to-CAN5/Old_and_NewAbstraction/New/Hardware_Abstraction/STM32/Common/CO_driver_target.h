...
/******************************************************************************************* */
 #define CANtoCAN // Project Specific definition for CAN to CAN communication Nidec-Specific 
/******************************************************************************************* */
// E.g., ignore only heartbeat consumer error, but not others
//#define CO_CONFIG_ERR_CONDITION_COMMUNICATION   (CO_EMC_MASK & ~(1U << CO_EM_HEARTBEAT_CONSUMER))

// Configuration defines for CANopenNode. **********************************************************/
...
#define CO_CONFIG_NMT (CO_CONFIG_GLOBAL_FLAG_CALLBACK_PRE | CO_CONFIG_GLOBAL_FLAG_TIMERNEXT |CO_CONFIG_NMT_CALLBACK_CHANGE)
#define NMT_CONTROL (CO_NMT_ERR_ON_ERR_REG | CO_ERR_REG_GENERIC_ERR | CO_ERR_REG_COMMUNICATION)
#define CO_CONFIG_NMT_MASTER (CO_CONFIG_NMT | CO_CONFIG_NMT_MASTER | \
                       CO_CONFIG_FLAG_CALLBACK_PRE | CO_CONFIG_GLOBAL_FLAG_CALLBACK_PRE | \
                       CO_CONFIG_GLOBAL_FLAG_TIMERNEXT | CO_CONFIG_GLOBAL_FLAG_OD_DYNAMIC)
/* HB consumer configuration defines made for project specific configs. ***********************************************************/
#define CO_CONFIG_HB_CONS_ENABLE (CO_CONFIG_HB_CONS_ENABLE | CO_CONFIG_FLAG_CALLBACK_PRE | CO_CONFIG_GLOBAL_FLAG_CALLBACK_PRE |CO_CONFIG_HB_CONS_CALLBACK_CHANGE |CO_CONFIG_HB_CONS_QUERY_FUNCT )
/***************************************************************************************************************/

#define CO_CONFIG_SDO_SRV (CO_CONFIG_SDO_SRV_SEGMENTED | CO_CONFIG_FLAG_CALLBACK_PRE | CO_CONFIG_GLOBAL_FLAG_CALLBACK_PRE)
#define CO_CONFIG_PDO (CO_CONFIG_RPDO_ENABLE | CO_CONFIG_RPDO_TIMERS_ENABLE | \
                       CO_CONFIG_TPDO_ENABLE | CO_CONFIG_TPDO_TIMERS_ENABLE | \
