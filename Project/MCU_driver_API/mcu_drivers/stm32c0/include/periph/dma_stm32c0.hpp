...
namespace periph { class dma_stm32c0; }
// For internal use only! (called from ISR)
extern "C" void dma_irq_hndlr(periph::dma_stm32c0 *obj);
...
public:
     ...
     */
    dma_stm32c0(uint8_t dma, uint8_t channel, enum direction direction, uint8_t increment_size);
    ~dma_stm32c0();
    ...
    dma_stm32c0(const dma_stm32c0&) = delete;
    dma_stm32c0& operator=(const dma_stm32c0&) = delete;

    // Delete move constructor and move assignment operator
    dma_stm32c0(dma_stm32c0&&) = delete;
    dma_stm32c0& operator=(dma_stm32c0&&) = delete;
...
private:
    ...
    friend void ::dma_irq_hndlr(dma_stm32c0 *obj);
};
} // namespace periph
