...
#endif
/**
 * @brief Import the header of the used hardware fmaily.
 */
...
#include "stm32x0_gpio_mapping.hpp"
	...
	namespace stm32
	{
		...
		public:
			...
			[[nodiscard]] uint16_t getPinNumber() const;
			...
			//	[[nodiscard]] Pin_State getPinState() const;
			void writePin(bool value) const final;
			bool isPinOn() const;
