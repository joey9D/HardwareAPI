...
extern "C" void uart_irq_hndlr(periph::uart_stm32c0 *obj);

namespace periph
{
class uart_stm32c0 : public uart
{
public:
     ...
     */
    uart_stm32c0(uint8_t uart, uint32_t baudrate, enum stopbits stopbits, enum parity parity,
    ...
    uart_stm32c0(const uart_stm32c0&) = delete;
    uart_stm32c0& operator=(const uart_stm32c0&) = delete;

    // Delete move constructor and move assignment operator
    uart_stm32c0(uart_stm32c0&&) = delete;
    uart_stm32c0& operator=(uart_stm32c0&&) = delete;
...
private:
    ...
    parity parity;
    dma_stm32c0 &tx_dma;
    gpio_stm32c0 &tx_gpio;
    res tx_irq_res;
    dma_stm32c0 &rx_dma;
    gpio_stm32c0 &rx_gpio;
    uint16_t *rx_cnt;
    res rx_irq_res;
    SemaphoreHandle_t api_lock;
    TaskHandle_t task;

    void gpio_af_init(gpio_stm32c0 &gpio);
    static void remap_dma(uint8_t spi, dma_stm32c0 &dma);
    void on_dma_tx(dma_stm32c0::event event);
    void on_dma_rx(dma_stm32c0::event event);
    friend void ::uart_irq_hndlr(uart_stm32c0 *obj);
};
} // namespace periph
