...
namespace periph
{
class gpio_stm32c0 : public gpio
{
public:
     ...
     */
    gpio_stm32c0(enum port port, uint8_t pin, enum mode mode, bool state = false);
    ~gpio_stm32c0();
    ...
    gpio_stm32c0(const gpio_stm32c0&) = delete;
    gpio_stm32c0& operator=(const gpio_stm32c0&) = delete;

    // Delete move constructor and move assignment operator
    gpio_stm32c0(gpio_stm32c0&&) = delete;
    gpio_stm32c0& operator=(gpio_stm32c0&&) = delete;
