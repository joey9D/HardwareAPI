...
namespace periph
{
class timer_stm32c0 : public timer
{
public:
    ...
    timer_stm32c0(const timer_stm32c0&) = delete;
    timer_stm32c0& operator=(const timer_stm32c0&) = delete;

    // Delete move constructor and move assignment operator
    timer_stm32c0(timer_stm32c0&&) = delete;
    timer_stm32c0& operator=(timer_stm32c0&&) = delete;
...
private:
    ...
    friend void ::tim_irq_hndlr(timer_stm32c0 *obj);
};
} // namespace periph
