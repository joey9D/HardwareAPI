...
static timer_stm32c0 *obj_list[timer_stm32c0::timers];

timer_stm32c0::timer_stm32c0(uint8_t timer)
{
...
void timer_stm32c0::set_callback(std::function<void()> on_timeout)
{
    this->on_timeout = std::move(on_timeout);
}

void timer_stm32c0::timeout(std::chrono::microseconds timeout)
{
...
void timer_stm32c0::start(bool is_cyclic)
{
...
bool timer_stm32c0::is_expired() const
{
    return !(timer_hw_mapping::timer[tim]->CR1 & TIM_CR1_CEN);
}

void timer_stm32c0::calc_clk(uint8_t tim, uint32_t usec, uint16_t &psc, uint16_t &arr)
{
...
extern "C" void tim_irq_hndlr(periph::timer_stm32c0 *obj)
{
