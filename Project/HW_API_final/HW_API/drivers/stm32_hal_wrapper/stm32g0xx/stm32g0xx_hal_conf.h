 ...
 * @brief   HAL configuration file for STM32G0xx family
 *          Based on STM32C0xx template and adapted for G0xx specifics
 ******************************************************************************
 * @attention
 *
 ...
 *        the default weak callback functions (see each stm32g0xx_hal_ppp.h file
...
#define USE_RTOS 0U
#define PREFETCH_ENABLE 1U          /*!< Enable prefetch for STM32G0xx */
#define INSTRUCTION_CACHE_ENABLE 1U /*!< Enable instruction cache for STM32G0xx */
